...
export default function Report11({ print }: { print: boolean }) {
  return (
    <div
      style={{
        position: "relative",
    ...
    >
      ...
      <div className="p-4 flex-1">
        ...
        <div className="mb-4">
          <h2 className="text-lg font-bold mb-3">UITF(PESO)</h2>
          <div className="border border-black rounded-lg overflow-x-auto">
            <table className="w-[85%] text-xs">
              <thead>
                <tr>
        ...
        <div className="mb-4">
          <h2 className="text-lg font-bold mb-3">UITF(USD)</h2>
          <div className="border border-black rounded-lg overflow-x-auto">
            <table className="w-[85%] text-xs">
              <thead>
                <tr>
